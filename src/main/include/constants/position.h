...
namespace algae {
  ...
  constexpr Position algaeNetLeft{.elevator_height = measure_up::elevator::elevator::maxHeight, .arm_angle = 69_deg, .wrist_angle = -90_deg};
  constexpr Position algaeNetRight{.elevator_height = measure_up::elevator::elevator::maxHeight, .arm_angle = 111_deg, .wrist_angle = 90_deg};
