...
namespace setpoints {
  ...
  constexpr Position levelTwoRight{.elevator_height = 21.5_in, .arm_angle = 127_deg, .wrist_angle = 0_deg};
  constexpr Position levelTwoLeft{.elevator_height = 21.5_in, .arm_angle = 63_deg, .wrist_angle = 0_deg};
  constexpr Position levelThreeRight{.elevator_height = 37.5_in, .arm_angle = 125_deg, .wrist_angle = 0_deg};
  constexpr Position levelThreeLeft{.elevator_height = 37.5_in, .arm_angle = 61_deg, .wrist_angle = 0_deg};
