...
def get_quaternion_angle_difference(q1: Quaternion, q2: Quaternion) -> float:
    ...
    dot_product = (q1_norm.w * q2_norm.w +
                  q1_norm.x * q2_norm.x +
                  q1_norm.y * q2_norm.y +
                  q1_norm.z * q2_norm.z)
...
def main():
    ...
    examples = [
        Example(
            ...
            q1=Quaternion(w=0.000000000000000006123233995736766, x=0, y=0, z=1.0),  # Identity quaternion
            q2=Quaternion(w=0.001740148123557302, x=-0.005060063594917707, y=-0.002028597171044279, z=0.999836260831679)  # 90-degree rotation around X
        ),
        Example(
        ...
        Example(
            ...
            q1=Quaternion(w=1, x=0, y=0, z=0),  # Identity quaternion
            q2=Quaternion(w=0.9238795325112867, x=0, y=0, z=0.3826834323650898)  # 45-degree rotation around Z
        )
    ]
